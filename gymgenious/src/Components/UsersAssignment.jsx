...
export default function UserAssignment({ onUsersChange, routine,routineDay }) {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const assignedResponse = await fetch(`https://two024-duplagalactica.onrender.com/get_assigned_routines`, {
        method: 'GET', 
        headers: {
      ...
      const allUsersResponse = await fetch(`https://two024-duplagalactica.onrender.com/get_users`, {
        method: 'GET', 
        headers: {
          'Authorization': `Bearer ${authToken}`
        }
